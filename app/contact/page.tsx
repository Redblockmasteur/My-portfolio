...
const ContactPage: NextPage = () => {
    ...
    <div>
        ...
        <p className=" mt-3 text-justify text-lg">N'hésitez pas à me connecter si vous souhaitez discuter de mes projets ou de mes expériences professionnelles. Je ferai de mon mieux pour répondre à votre message dans les plus brefs délais. <br /> Je vous remercie de l'intérêt que vous portez à mon travail.</p>
